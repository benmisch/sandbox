...
public class BenaryTree<K, V> {
  ...
  // Recursive. Arbitrary decision rule: if child-to-be is greater than or equal
  // to node, then right; else, left.
  private Node insert(Node node, Entry child) {
    ...
    int comparison = child.compareTo(node.data);
